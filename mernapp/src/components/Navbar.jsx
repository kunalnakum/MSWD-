  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: '#3B5998' }}>
      <div className="container-fluid">
        <Link className="navbar-brand fs-1 fst-italic" to="/">Grocery</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          {!localStorage.getItem("authToken") ?
            <div className='d-flex'>
              ...
              <Link className="btn btn-outline-light mx-1" to="/creatuser">SignUp</Link>
            </div>
            :
            <div>
              ...
              <div className='btn btn-outline-light mx-2' onClick={handleLogout}> Logout</div>
            </div>
          }
        </div>
      </div>
